...
var WeatherComponent = (function () {
    function WeatherComponent(service) {
        ...
        this.icons = new Skycons(); // IDE complains because this is JavaScript library which doesn't have TypeScript definition file
    ...
    WeatherComponent = __decorate([
        core_1.Component({
            ...
            providers: [weather_service_1.WeatherService] // We can put it in a root module (app.module.ts) but this service is only for this
        }), 
